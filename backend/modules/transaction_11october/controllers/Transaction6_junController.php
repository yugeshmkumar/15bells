        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'update', 'index', 'create', 'view', 'delete', 'virtual', 'bid', 'nsertajax', 'grid','endbid','changestatus'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
...
<td align=center><b>Bid Date</b></td>
 <td align=center><b>Status</b></td>";
    ...
    public function actionTime() {
        ...
        //echo "<br/>";
        //   $t1='+'.$time." minutes";
        //$add=date("$schedule_time",strtotime($t1));


        $amt = "update timer set fromtime='$schedule_time', timer='$time'";
        $command_get = $connection->createCommand($amt);
        $command_get->query();
    }
