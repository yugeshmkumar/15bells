...
use common\models\WebsiteconfigSearch;
...
/**
 * WebsiteconfigController implements the CRUD actions for Websiteconfig model.
 */
class WebsiteconfigController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Websiteconfig",
                ...
                return [
                    ...
                    'title'=> "Create new Websiteconfig",
                    'content'=>'<span class="text-success">Create Websiteconfig success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Websiteconfig model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Websiteconfig model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
