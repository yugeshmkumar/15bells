...
use common\models\ContactbackendSearch;
...
class ContactusController extends Controller
{
    ...
    public $layout = "csr_demand_layout";
    ...
    {    
        $searchModel = new ContactbackendSearch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new ContactUs",
                    'content'=>'<span class="text-success">Create ContactUs success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing ContactUs model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ContactUs model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
