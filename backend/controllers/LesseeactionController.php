...
//where property_for = 'rent' AND a.user_id <> '$user_id' AND town_name = '$town' AND sector_name='$sector' AND total_plot_area <='$total_area'  GROUP BY a.id
     ...
     public function actionWithoutshapebackend($location,$foodexpectid, $whichserch, $area,$town,$sector,$areamin,$areamax,$pricemin,$pricemax,$proptype,$propbid,$food) {
...
//           longitude BETWEEN '" . $min_lon . "' AND '" . $max_lon . "') GROUP BY a.id ";    
    ...
    public function actionMapproperty1update() {
     ...
     public function actionMapproperty1($location,$center, $shapes,$foodexpectid, $whichserch, $town,$sector, $northeast, $southwest, $latcenter, $longcenter, $totalradius, $area,$areamin,$areamax,$pricemin,$pricemax,$proptype,$propbid,$food) {
...
\common\models\activemode::update_my_profile_progress_status($user_id,"my_search",'100','4');
    ...
    public function actionMapproperty2update() {
     ...
     public function actionMapproperty2($northlat,$southlat,$northlng,$southlng,$location,$newkuma, $center,$foodexpectid, $whichserch, $shapes, $town,$sector, $maxim, $minim, $maximy, $minimy, $area,$x,$y,$areamin,$areamax,$pricemin,$pricemax,$proptype,$propbid,$food) {
