...
<div align="center"><a onclick="cslo(<?php echo $refstr ?>,<?php echo $totalchk ?>),document.getElementById('createslotsambqwksukvveekmuzqtsimabbff').style.display='block';document.getElementById('cretaeslotsambqwksukvveekmuzqtsimaccff').style.display='block'" style="cursor:pointer; text-decoration:none; color:#3b5998;">Create a new Slot</a></div>

<div id="csolo1uu">
<?php
$getslot = event_config::find()
    ->where(['myid' => Yii::$app->user->identity->id , 'event_holder_id' => $refstr,'request_site_id'=>$totalchk])
    ->orderBy('id desc')
    ->all();
	?>
...
<?php echo Html::Button('Send',['class'=>'acceptbut','name'=>'createslot','onClick'=>"return jamsslot('createslot')",'class'=>'btn btn-success']);?>
