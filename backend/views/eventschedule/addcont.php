...
$qqaucust->request_site_id=$requestid;
...
$getslot = event_config::find()
    ->where(['myid' => Yii::$app->user->identity->id , 'event_holder_id' => $refstr,'request_site_id'=>$requestid])
    ->orderBy('id desc')
    ->all();
	?>
