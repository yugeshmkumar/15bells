    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                ...
                <a onclick="document.getElementById('cobcreateslotsambqwksukvveekmuzqtsimabbff').style.display = 'block';
                        document.getElementById('cobcretaeslotsambqwksukvveekmuzqtsimaccff').style.display = 'block', faula()"><input type="datetime-local"  name="ev2" id="ev2" spellcheck="false" class="form-control" style="resize:none;" /></a></td>

            <td>
                <label class="lable_popup">To Date and time</label> 
                <a onclick="document.getElementById('cobcreateslotsambqwksukvveekmuzqtsimabbff').style.display = 'block';
                        document.getElementById('cobcretaeslotsambqwksukvveekmuzqtsimaccff').style.display = 'block', faula()"><input type="datetime-local"  name="ev3" id="ev3" spellcheck="false" class="form-control" style="resize:none;" /></a></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
            <tr> 
                <td align="left" valign="middle">
                    <a onclick="document.getElementById('createslotsambqwksukvveekmuzqtsimabbff');
                            document.getElementById('createslotsambqwksukvveekmuzqtsimaccff'), slotcont(<?php echo $refstr ?>,<?php echo $requestid ?>)">
                        <img height="100" src="https://www.jquery-az.com/wp-content/uploads/2015/12/2.2-HTML-img-src-relative.jpg" /></a>
                </td> 
