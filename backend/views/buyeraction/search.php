                    ...
                    <!-- END PAGE BAR -->
							 <div id="firststep" class="col-md-4 col-sm-4 animated bounce filter_s">
							   ...
							   <div class="col-md-4 text-center expectation_delet_btn_div filter_s">
                                   <span class="exp_ect"> <?= Html::button('Create Expectations',['value'=>Url::to('https://www.15bells.com/backend/web/sellor-expectations/creates'),'class'=>'btn btn-success expectation_div_button','id'=>'modalButton']) ?>
...
//                                         var maxXcoordinate =  Math.max(xcoordinates); 
                                 ...
                                 var map = new google.maps.Map(document.getElementById('map-canvasd'), {
                                     ...
                                     zoom: 12
                                          ...
                                          ndata = {location:getsearchlocation,area:getexpectationID,town:town,sector:sector,country:country,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid,food:food}; 
                                     ...
                                     ((this.countyview > 0 ? '<div class="col-md-3 col-sm-3 col-xs-3"> <i class="fa fa-eye" aria-hidden="true"></i></div>' : '')) +
                                        ...
                                        '</div>');
                                          ...
                                          ndata = {location:getsearchlocation,maxi: maxi,mini : mini,maxiy :maxiy,miniy : miniy,shapes:shapes,town:town,sector:sector,newpath:newpath,area:getexpectationID,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid,food:food}; 
                                   ...
                                   toastr.success('Your Search Criteria has Successfully Saved', 'success');             
                                           var maxi = xcoordinates.reduce(function(a, b) {
                                            ...
                                            return Math.min(a, b);
                                               ...
                                               ndata = {maxi: maxi,mini : mini,maxiy :maxiy,miniy : miniy,shapes:shapes,town:town,sector:sector,newpath:newpath,area:getexpectationID,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid,food:food}; 
