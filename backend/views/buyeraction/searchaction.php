...
<div class="row text-center">
		<div class="col-md-6 diffrnt_search">
			 	<div>
						  <label>
							<input type="radio" value="client" class="option-input radio" name="example" />
							Client Search
						  </label>
		...
		<div class="col-md-6 diffrnt_search">
				<div>
					<label>
							<input type="radio" value="universal" class="option-input radio" name="example" checked />
							Universal Search
					</label>
				</div>
		</div>
...
<!--Radio group-->
    ...
    <a href="<?php echo Yii::$app->urlManager->createUrl(['site/userdash']) ?>">Home</a>
                    ...
                    <!-- END PAGE BAR -->
							 ...
							 <div id="firststep" class="col-md-4 col-sm-4 animated bounce filter_s">
							   ...
							   <div class="col-md-4 text-center expectation_delet_btn_div filter_s">
                                   <span class="exp_ect"> <?= Html::button('Create Expectations',['value'=>Url::to('https://www.15bells.com/backend/web/sellor-expectations/updated?id='.$expectationID.''),'class'=>'btn btn-success expectation_div_button','id'=>'modalButton']) ?>
...
//                                         var maxXcoordinate =  Math.max(xcoordinates); 
                                 ...
                                 var map = new google.maps.Map(document.getElementById('map-canvasd'), {
                                     ...
                                     zoom: 12
                                          ...
                                          ndata = {location:getsearchlocation,area:getexpectationID,town:town,sector:sector,country:country,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid,food:food,foodexpectid:foodexpectid,whichserch:whichserch}; 
                                   ...
                                   toastr.success('Your Search Criteria has Successfully Saved', 'success');             
                                           var maxi = xcoordinates.reduce(function(a, b) {
                                            ...
                                            return Math.min(a, b);
                                               ...
                                               ndata = {maxi: maxi,mini : mini,maxiy :maxiy,miniy : miniy,shapes:shapes,town:town,sector:sector,newpath:newpath,area:getexpectationID,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid,food:food,foodexpectid:foodexpectid,whichserch:whichserch}; 
