                                        ...
                                        <table class="table table-hover table-light">
											...
											<?php $arruserkyc = \common\models\UserKycdocuments::find()->where(['userid'=>$userid,'isactive'=>1])->all(); ?>
											   ...
											   <tr>
                                                    ...
                                                    <td><a href="<?php echo Yii::getAlias('@archiveUrl') ?>\kycdocuments\<?php echo $userkyc->document_file_name_extenstn ?>" target="_blank" style="color:#000000;"><?php echo $userkyc->docment_file_name ?> <i class="fa fa-share"></i></a>  </td>
