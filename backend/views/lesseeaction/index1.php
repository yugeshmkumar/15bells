...
//            echo '<pre>';print_r($data);die;
                    ...
                    <div class="col-md-12 property_main_div_2">
                        <div class="row">
                            ...
                            <div class="col-md-6 property_main_div_2_inner_2">
                                ...
                                <a class="btn btn-default" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/view?id=' . $datas['id'] . '']) ?>" target="_blank" role="button">More Details <i class="fa fa-caret-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 property_main_div_2_inner_p">
                        <ul class="list_li">
                            <li><p>₹ <?php echo $datas['expected_price']; ?> </p></li>
    ...
    <?php
    echo (($datas['undercategory'] == 'Residential') ?
            '<li><i class="fa fa-bed" aria-hidden="true"></i> ' . $datas['bedrooms'] . '</li>
                         <li><i class="fa fa-bath" aria-hidden="true"></i> ' . $datas['bathrooms'] . '</li>' : '' )
    ?>
    ...
    <?php
    echo (($datas['request_for'] == 'Instant') ?
            '<div class="col-md-5 text-center property_main_div_3_inner1">
                            ...
                            </div>' : '<div class="col-md-5 text-center property_main_div_3_inner1">
