...
<!--<i class="fa fa-map-marker" aria-hidden="true"></i>-->
            ...
            <div class="col-md-4 text-cente filter_s text-center">
                <span class="exp_ect">
<?= Html::button('Create Expectations', ['value' => Url::to('https://www.15bells.com/backend/web/lessor-expectations/creates?userid='.$_GET['id'].''), 'class' => 'btn btn-success expectation_div_button', 'id' => 'modalButton']) ?>
            ...
            if (town == '' && sector == '') {
                ...
                if (getsearchlocation != '' || shapes != '') {
                    ...
                    if (shapes == '') {
                        ...
                        ndata = {location: getsearchlocation, area: getexpectationID, town: town, sector: sector, areamin: areamin, areamax: areamax, pricemin: pricemin, pricemax: pricemax, proptype: proptype, propbid: propbid,food:food};
                            ...
                            success: function (data) {
                                ...
                                $.each(obj, function (index) {
                                    ...
                                    $('#getprop').append('<div class="col-md-6 serch_row chirag" style="">' +
                                            ...
                                            '<ul class="list_li">' +
                                            '<li><p>₹  ' + this.asking_rental_price + ' Psf </p></li>' +
                    ...
                    if (shapes == 'polygon') {
                        ...
                        ndata = {location:getsearchlocation,maxi: maxi, mini: mini, maxiy: maxiy, miniy: miniy, shapes: shapes, newpath: newpath, area: getexpectationID, town: town, sector: sector, areamin: areamin, areamax: areamax, pricemin: pricemin, pricemax: pricemax, proptype: proptype, propbid: propbid,food:food};
...
//
                    ...
                    if (shapes == 'polyline') {
                        ...
                        ndata = {maxi: maxi, mini: mini, maxiy: maxiy, miniy: miniy, shapes: shapes, town: town, sector: sector, newpath: newpath, area: getexpectationID, town:town, sector:sector, areamin: areamin, areamax: areamax, pricemin: pricemin, pricemax: pricemax, proptype: proptype, propbid: propbid,food:food};
...
//                                                    alert(data);
    ...
    function propdetails(id) {
        ...
        window.open('http://staging.15bells.com/frontend/web/addproperty/viewsearch?id=' + id, '_blank');
