...
?>
 ...
 <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-send"></i> Revise Proposal</div>
                                                <div class="tools">
												 <a onclick="document.getElementById('viewpsambqwksukvveekmuzqtsimabbfff').style.display='none';document.getElementById('viewpsambqwksukvveekmuzqtsimaccfff').style.display='none'" style="cursor:pointer; color:#FFFFFF; font-weight:800;">x</a>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title tabbable-line">
                                                <div class="caption caption-md">
                                                    ...
                                                    <span class="caption-subject font-blue-madison bold uppercase">Send Revise Proposal</span>
                                                </div>
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#tab_1_1" data-toggle="tab">Send Revise Proposal</a>
                                                    </li>
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="#">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file"  id="file" name="file" placeholder="Doe" class="form-control" rows="3"/>
                                                            ...
                                                            <div class="margiv-top-10">
                                                                <a onclick="sendreviseproposalaction('<?php echo $leadid ?>');window.location.reload();" href="javascript:;" class="btn green">Send</a>
																 <a onclick="document.getElementById('viewpsambqwksukvveekmuzqtsimabbfff').style.display='none';document.getElementById('viewpsambqwksukvveekmuzqtsimaccfff').style.display='none'" style="cursor:pointer;font-weight:800;"  class="btn default">
...
function sendreviseproposalaction(str){
              var fileid=$('#file').val();
         ...
         $.ajax({
				...
				url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/sendreviseproposalaction"]) ?>?leadid="+str+"&fileid="+fileid+"&message="+message,
