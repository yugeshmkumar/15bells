        ...
        <p><div class="leadrequest-index">
            ...
            <?php if ($pr && $_GET['status']) {   ?>
                ...
                if ($rbac->item_name == "csr_head") {
                    $dataProvider = $searchModel->searchbystatusndproduct_forhead(Yii::$app->request->queryParams, $_GET['status'], $_GET['pr']);
                } else {
            ...
            <?php } else if (isset($_GET['status'])) { ?>
                ...
                ?>
                <?=
                Yii::$app->controller->renderPartial('gridviewforallotedindex', [
                    'searchModel' => $searchModel,
                    'dataProvider' => $dataProvider,
                        //'classid'=>$_GET["cat"],
                ]);
...
<script>
    ...
    function getcompanydetails(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/companydetails"]) ?>?leadid=" + str,
...
<script>
    ...
    function getproductdetails(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/productdetails"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function assignlead(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignlead"]) ?>?leadid=" + str,
            success: function (msg) {
...
function assignleaddemand(str) {


        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignleaddemand"]) ?>?leadid=" + str,
            success: function (msg) {
...
function assignleadsales(str) {


        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignleadsales"]) ?>?leadid=" + str,
            success: function (msg) {
...
function assignleadsalessupply(str) {


        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignleadsalessupply"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function assignleadaccept(str, ttr) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignleadaccept"]) ?>?leadid=" + str + "&status=" + ttr,
            success: function (msg) {
...
<script>
    ...
    function functionprofilepl(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/reverselead"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function assignleadreject(str, ttr) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/assignleadreject"]) ?>?leadid=" + str + "&status=" + ttr,
            success: function (msg) {
...
<script>
    ...
    function addleaddetails(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/addleaddetails"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function schedule(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/schedule"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function followuponproposal(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/followuponproposal"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function addproposal(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/addproposal"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function createanorder(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/createanorder"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function sendcompleteemail(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/sendcompleteemail"]) ?>?leadid=" + str,
            success: function (msg) {
...
<script>
    ...
    function rejectlead(str) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/rejectlead"]) ?>?leadid=" + str,
            success: function (msg) {
