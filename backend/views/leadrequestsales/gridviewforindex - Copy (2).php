...
echo GridView::widget([
   ...
   [
    ['class' => 'kartik\grid\SerialColumn'],
	 ...
	 [
			...
			'detail' => function($data){
			 ...
			 $searchModel = new \common\models\MyprofilecheckSearch();
			...
			<div class="btn-group">
											...
											<li>
                                                  <a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbffa&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccffa&#39;).style.display=&#39;block&#39;,assignlead('.$data->id.')">
                                                        ...
                                                        <span class="label label-sm label-default"> <i class="fa fa-send"></i></span> Assign
                                                    </a>
                                                </li>
											 <li>
											 <a href="'.Yii::$app->urlManager->createUrl(['leadrequest/update?id='.$data->id.'']).'" target="_blank">
						   <span class="label label-sm label-default"><i class="fa fa-plus"></i></span> Add Details
                                                    </a>
                                                    
													<!--<a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbffd&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccffd&#39;).style.display=&#39;block&#39;,addleaddetails('.$data->id.')">
						   <span class="label label-sm label-default"><i class="fa fa-plus"></i></span> Add Details
                                                    </a>-->
                                                </li>
                                                <li>
                                                  <a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbffa&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccffa&#39;).style.display=&#39;block&#39;,assignlead('.$data->id.')">
                                                        ...
                                                        <span class="label label-sm label-default"> <i class="fa fa-trash-o"></i></span> Reject
                                                    </a>
                                                </li>
    ...
    [
	   ...
	   return '
	   <div class="btn-group">
                                                                        <a  href="#basic" type="button"  data-toggle="dropdown" data-hover="dropdown" data-close-others="true">'.$data->first_name.'
                                                                        </a>
                                    ...
                                    <div class="profile-usertitle">
                                        <div class="profile-usertitle-name"> '.$data->first_name.' </div>
	   ...
	   [
        ...
        'width'=>'250px',
		  ...
		  'value'=>function($data) {
			    $docsmain[]='';
                          $docsmain[]='<strong>&nbsp;<a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbff&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccff&#39;).style.display=&#39;block&#39;,getuserIDdetails('.$data->id.')"></a>&nbsp;</strong>';
                          
                           return '<a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbff&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccff&#39;).style.display=&#39;block&#39;,getuserIDdetails('.$data->id.')">'.\common\models\user::findOne($data->userID)->email.'</a>'.implode($docsmain).'
						   ';
	...
	[
        ...
        'noWrap'=>true,
		  'value'=>function ($data) {
			...
			if($getleadstatus){
           $docsmain[]='<strong>&nbsp;<a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbffx&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccffx&#39;).style.display=&#39;block&#39;,getproductdetails('.$data->id.')"></a>&nbsp;</strong>';
                          
                           return '<a onclick="document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimabbffx&#39;).style.display=&#39;block&#39;;document.getElementById(&#39;viewpsambqwksukvveekmuzqtsimaccffx&#39;).style.display=&#39;block&#39;,getproductdetails('.$data->id.')"><code>
						   </code></a>'.implode($docsmain).'
						   ';
			}else{
    ...
    [
	 ...
	 [
        ...
        'attribute'=>'id',
           'format'=>'raw',		
		'value'=>function($data){
			$findcurrentprogress = \common\models\Leadcurrentstatus::find()->where(['leadid'=>$data->id,'isactive'=>1])->one();
			
			if($findcurrentprogress){
				 $leadstatusconfig=\common\models\Leadstatusconfig::find()->where(['id'=>$findcurrentprogress->leadactionstatus])->one();
				$count = $leadstatusconfig->percentsum;
			}else{
				$count =0;
			}
			return '
			<div class="row">
                                        <div class="col-md-4">
                                            <div class="easy-pie-chart">
                                                <div class="number transactions" data-percent="'.$count.'">
                                                    <span>+'.$count.'</span>% </div>
