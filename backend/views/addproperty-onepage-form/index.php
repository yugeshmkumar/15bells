...
// alert( $( "input[name$='datetime_10']" ).val());
  ...
  $.ajax({
      type: "POST",
      url: 'addproperty-onepage-form/savescheduledtime',
...
var visittypeid = $('#visittypeid').val();
     ...
     if(radioValue){
       ...
       $.ajax({
               type: "POST",
               url: 'addproperty-onepage-form/setvisittype',
...
function site_visit(visitid,visittype) {
        ...
        $('#visittype').val(visittype);
                                    $.ajax({
						                        type: "POST",
                                                url: 'addproperty-onepage-form/getvisittype',
...
function addremarks(visitid) {
        ...
        $('#remarkid').val(visitid);
                     ...
                     $.ajax({
                           type: "POST",
                                       url: 'addproperty-onepage-form/getremarks',
                                       data: {visitid: visitid},
                                       //dataType: 'json',
                                       success: function (data) {  
 ...
 var remarks_comment  =  $('#remarks_comment').val();
       ...
       $.ajax({
               type: "POST",
               url: 'addproperty-onepage-form/setremarks',
