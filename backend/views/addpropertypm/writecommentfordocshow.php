...
<?php $pid = $_GET['pid'];
      $rsiteid = $_GET['r_siteid'];
	   $RequestSiteVisitbin = \common\models\Showdocuments::find()->where(['id'=>$rsiteid])->one();
	     
	   ?>

<div class="portlet box green">
							<div class="portlet-title">
							<div class="caption"><?php if($RequestSiteVisitbin){ ?><?php echo \common\models\User::findOne($RequestSiteVisitbin->userid)->email ?><?php } ?></div>
							<div class="tools">
...
$.ajax({
				...
				url: "<?php echo Yii::$app->urlManager->createUrl(["addpropertypm/updatedocscommentaction"]) ?>?writecomment="+writecomment+"&r_sid="+str,
