...
?>
<?php $mediaconfigdocumentID = $_GET['id'];
       $currentstatus  = $_GET['ca']; 
	   $doctype = \common\models\MediaFilesConfig::find()->where(['id'=>$mediaconfigdocumentID])->one();
	   
	   $userproperty = \common\models\Addproperty::find()->where(['id'=>$doctype->property_id])->one();
	   $user = \common\models\User::find()->where(['id'=>$userproperty->user_id])->one();
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                       <?php echo \common\models\MediaFiles::findOne($doctype->id)->file_name ?>
                                                    </td>
                                                </tr></tbody></table> </div>
...
$.ajax({
				...
				url: "<?php echo Yii::$app->urlManager->createUrl(["addpropertypm/updatestatusaction"]) ?>?writecomment="+writecomment+"&id="+str+"&ca="+ttr,
