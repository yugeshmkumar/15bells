             ...
             <div class="row">
                 ...
                 <div class="col-md-12 text-center" style="padding-top:30px;">
					<ul class="list_viw">
						...
						<li><a href="javascript:void(0)" onclick="contactus(<?php echo $viewid ?>)" class="list_anchr">Contact Us</a></li>
						<li><a href="javascript:void(0)" onclick="getchecki(<?php echo $viewid ?>)" class="list_anchr">Shortlist Property</a></li>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
							<div class="container-fluid">
                                                <?php $getseller = \common\models\Addproperty::find()->where(['id'=>$viewid])->one();
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->rent_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->interest_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->agreement_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
									</div>
									<div class="col-md-12 veiw_property_description_div">
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   <b>Lease tenure</b><br>
											   <span><?php echo $getlessorexpec->lease_tenure;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->tenure_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->lock_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->escalation_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->last_date_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
									</div>
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->fit_out_negotiable;  ?></span>
											 </div>
										   </div>
										 </div>
										 <div class="col-md-4">
										 ...
										 <div class="col-md-4">
										   <div class="row">
											 ...
											 <div class="col-sm-10 veiw_property_description_div_inner">
											   ...
											   <span><?php echo $getlessorexpec->power_can_be_discussed;  ?></span>
											 </div>
										   </div>
										 </div>
									</div>
    ...
    <script>
                     ...
                     function directitnow(id) {
                                           ...
                                           $.ajax({
                                                ...
                                                url: 'http://staging.15bells.com<?= Yii::$app->urlManager->createUrl("lesseeaction/directitnow") ?>',
                                                data: {propertyid: id},
                  ...
                  function getfreevisit(id) {
                                            ...
                                            $.ajax({
                                                ...
                                                url: 'http://staging.15bells.com<?= Yii::$app->urlManager->createUrl("lesseeaction/getfreevisit") ?>',
                                                data: {hardam: id},
                                                success: function (data) {
                    ...
                    function getchecki(id) {                                            
                                            ...
                                            $.ajax({
                                                url: 'http://staging.15bells.com<?= Yii::$app->urlManager->createUrl("lesseeaction/saveprop") ?>',
                                                data: {hardam: id},
                                                success: function (data) {
                                    ...
                                    $('#draggable2').modal('show');
                                             ...
                                             function savemessage(){
                                                       ...
                                                       $.ajax({
                                                            ...
                                                            url: 'http://staging.15bells.com<?= Yii::$app->urlManager->createUrl("lesseeaction/savemessages") ?>',
