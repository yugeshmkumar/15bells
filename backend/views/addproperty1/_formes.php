            ...
            <div class="row"> 
                <div class="col-md-12" style="padding-top:15px;">
                    <div class="form-group">
                        ...
                        <label class="col-md-4 control-label" for="form_control_2">Property For</label>

                        <?= $form->field($model, 'property_for')->checkboxlist(['sale' => 'Sale'], ['value' => 'sale'])->label(false); ?>
               ...
               <!-- <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
						...
						<div class="col-md-6">
                        <?=
                        $form->field($model, 'project_type_id')->dropDownList(ArrayHelper::map(PropertyType::find()->where('undercategory =:one or undercategory =:two', array(':one' => "Residential", ':two' => "Commercial"))->andwhere(['isactive'=>'1'])->all(), 'id', 'typename'), [
...
<?php  }  }  ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
						...
						<div class="col-md-6">
                        <?= $form->field($model, 'city')->dropDownList([ 'Gurgaon' => 'Gurgaon', 'Mumbai' => 'Mumbai', 'Delhi' => 'delhi', 'Noida' => 'Noida'], ['prompt' => 'Select City', 'onchange' => 'getcity(this.value)'])->label(false) ?>
						</div>
		...
		<div class="container-fluid" style="background:rgba(255,255,255,0.25);padding:10px;">
            <div class="row">
				...
				<div class="col-md-12 no_pad">
					<div class="col-md-6" id="total_floors">
						<div class="form-group">
						<div class="col-md-6">
				...
				<div class="col-md-12 no_pad">
					<div class="col-md-6" id="bedrooms">
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
							<?= $form->field($model, 'bedrooms')->textInput()->label(false) ?>
							</div>
						</div>
					</div>
					<div class="col-md-6" id="bathrooms">
						<div class="form-group">
						<div class="col-md-6">
							<label class="control-label">Bathrooms *</label>
							</div>
							<div class="col-md-6">
							<?= $form->field($model, 'bathrooms')->textInput()->label(false) ?>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-12 no_pad">
					<div class="col-md-6" id="balconies">
						<div class="form-group">
						<div class="col-md-6">
							<label class="control-label">Balconies *</label>
							</div>
							<div class="col-md-6">
							<?= $form->field($model, 'balconies')->textInput([])->label(false) ?>
							</div>
						</div>
					</div>
					<div class="col-md-6" id="servant">
						<div class="form-group">
						<div class="col-md-6">
							<label class="control-label">Servant Room *</label>
							</div>
							<div class="col-md-6">
							<?= $form->field($model, 'servant_room')->textInput()->label(false) ?>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-12 no_pad">
					...
					<div class="col-md-6" id="parking">
						<div class="form-group">
						<div class="col-md-6">
							<label class="control-label">Reserved Parking *</label>
							</div>
							<div class="col-md-6">
							<?= $form->field($model, 'parking')->textInput()->label(false) ?>
							</div>
						</div>
					</div>
				</div>
            </div>
            <div id="another_rooms">
                <h4 class="form-section">Add Another Room</h4>
                <div class="row"> 
                    <div class="col-md-4" id="pooja_room">
                        <div class="form-group">


                            <?= $form->field($model, 'pooja_room')->checkbox(['value' => "1"]); ?>
                        </div>
                    </div>
                    <div class="col-md-4" id="study_room">
                        <div class="form-group">
                            <?= $form->field($model, 'study_room')->checkbox(['value' => "1"]); ?>

                        </div>
                    </div>


                    <div class="col-md-4" id="other_room">
                        <div class="form-group">
                            <?= $form->field($model, 'other_room')->checkbox(['value' => "1"]); ?>
            ...
            <div class="row"> 
				<div class="col-md-12 no_pad">
					...
					<div class="col-md-6" id="price_negotiable">
						...
						<div class="col-md-6">						
							<?= $form->field($model, 'price_negotiable')->dropDownList([ 'yes' => 'Yes', 'no' => 'No',], ['prompt' => 'Select Price Negotiable'])->label(false) ?>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-12 no_pad">
					<div class="col-md-6" id="asking_price">
						<div class="form-group">
						<div class="col-md-6">
            ...
            <div class="row">
					...
					<div class="col-md-6" id="price_sq_fts">
						...
						<div class="col-md-6">
							<label class="control-label">Price per sq.<span id="changeft">Ft</span> * </label>
								...
								<div class="col-md-6">
							<?= $form->field($model, 'price_sq_ft')->textInput()->input('text', ['placeholder' => "In Rs."])->label(false) ?>
							</div>
						</div>
					</div>
					<div class="col-md-6" id="price_acress">
						...
						<div class="col-md-6">
							<label class="control-label">Price per Acre</label> 
								...
								<div class="col-md-6">
							<?= $form->field($model, 'price_acres')->textInput()->input('text', ['placeholder' => "In Rs."])->label(false) ?>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 no_pad">
					<div class="col-md-6" id="mentanence_costs">
						<div class="form-group">
						<div class="col-md-6">
							<label class="control-label">Maintenance Cost</label>
							</div>
							<div class="col-md-6">
				...
				<div class="col-md-12 no_pad">
					...
					<div class="col-md-6" id="property_ages">
						...
						<div class="col-md-6">
							<?= $form->field($model, 'age_of_property')->dropDownList([ '0-1' => '0-1 Year Old Property', '1-5' => '1-5 Year Old Property', '5-10' => '5-10 Year Old Property', '10+' => '10+ Year Old Property',], ['prompt' => 'Select property age', 'id' => 'property_age'])->label(false) ?>
							</div>
...
$("#superbuilt_uit").change(function() {
  if ($(this).data('options') === undefined) {
    ...
    $(this).data('options', $('#carpet_uit option').clone());
  }
  var id = $(this).val();
  var options = $(this).data('options').filter('[value=' + id + ']');
  $('#carpet_uit').html(options);
});
...
//var cityname = document.getElementById('selcity');
    ...
    $(document).ready(function () {
        ...
        $('#project_type option:gt(8)').wrapAll('<optgroup label="Commercial" />');
    });
...
//alert('hiii1');
            ...
            if (val == '6' || val == '30') {
                $('#mentanence_costs').hide();
                $('#mentanence_bys').hide();
                $('#membership_charges').hide();

            } else {
                $('#mentanence_costs').show();
                $('#mentanence_bys').show();
                $('#membership_charges').show();
            }
            ...
            if (val == '11' || val == '12' || val == '13' || val == '14' || val == '15' || val == '16' || val == '17' || val == '18' || val == '19' || val == '20' || val == '21' || val == '22' || val == '23' || val == '24' || val == '25' || val == '26' || val == '27' || val == '28' || val == '29')
            {
                ...
                $('#exp_rentals').hide();
                $('#exp_rent_costs').hide();
				if (val == '11' || val == '13' || val == '15' || val == '22' || val == '18' || val == '23' || val == '16' || val == '12' || val == '24' || val == '17' || val == '25' || val == '26' || val == '27' || val == '28' || val == '29'){
					$('#availabilitys').show();
				}else{
                $('#availabilitys').hide();
				}
			...
			if (val == '18' || val == '12' || val == '25' || val == '26' || val == '27' || val == '28' || val == '11' || val == '13') {
                $('#revenues').hide();
			...
			if (val == '17') {
			   ...
			   if (val == '23' || val == '17' || val == '16' || val == '24' || val == '25' || val == '15') {
                $('#mentanence_bys').hide();
                $('#mentanence_costs').hide();
			   ...
			   if (val == '12' || val == '25' || val == '26' || val == '27' || val == '28' || val == '11' || val == '13' || val == '15' || val == '18' || val == '22') {
                $('#sheds').hide();
