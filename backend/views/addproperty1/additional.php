...
<div class="row">
    ...
    <div class="row step-thin">
     <a href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/updateb','id'=>$modelid]) ?>">
        ...
        <a href="<?php echo Yii::$app->urlManager->createUrl(['lessor-expectations/updateor','id'=>$lessorid]) ?>">
