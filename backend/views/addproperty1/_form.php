            ...
            <div class="row"> 
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?= $form->field($model, 'property_for')->checkboxlist(['rent' => 'Rent'], ['value' => 'rent'])->label(false); ?>
...
<?php  }  }?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?= $form->field($model, 'city')->dropDownList([ 'Gurgaon' => 'Gurgaon', 'Mumbai' => 'Mumbai', 'Delhi' => 'delhi', 'Noida' => 'Noida'], ['prompt' => 'Select City', 'onchange' => 'getcity(this.value)', 'id' => 'citym'])->label(false) ?>
            ...
            <div class="row"> 
                ...
                <div class="col-md-6" id="negotiables">
                    <div class="form-group">
                        ...
                        <?= $form->field($model, 'price_negotiable')->dropDownList([ 'yes' => 'Yes', 'no' => 'No',], ['prompt' => 'Select', 'id' => 'negotiable'])->label(false) ?>
                    </div>
                </div>
            ...
            <div class="row">
				...
				<div class="col-md-6" id="mentanence_costs">
						<div class="form-group">
							...
							<?= $form->field($model, 'maintenance_cost')->textInput(['maxlength' => true, 'id' => 'mentanence_cost'])->label(false) ?>
						</div>
					</div>
	...
	<?= $form->field($model, 'LOAN_taken')->dropDownList([ 'yes' => 'Yes', 'no' => 'No',], ['prompt' => 'Select', 'id' => 'loan_taken'])->label(false) ?>
                ...
                <div class="col-md-12 no_pad">
                    ...
                    <div class="col-md-3" id="available_froms">
                        <div class="form-group">
                    ...
                    <div class="col-md-3" id="available_date">
                        <div class="form-group">
...
//var cityname = document.getElementById('selcity');
    ...
    function gettype(val) {
		...
		if (val == '28' || val == '26' || val == '27' || val == '11' || val == '13' || val == '18' || val == '25' || val == '12' || val == '15' || val == '22' || val == '24'){
            $('#present_statuss').hide();
		...
		if (val == '28' || val == '26' || val == '27' || val == '11' || val == '13'){
			 $('#price_acress').hide();
			 
			} else {
			 $('#price_acress').show();
        }  
		if (val == '25' || val == '28' || val == '26' || val == '27' || val == '11' || val == '13' || val == '15' || val == '18' || val == '22' || val == '12' || val == '25'){
			 $('#sheds').hide();
