            ...
            <section class="sidebar">
                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            'label'=>Yii::t('backend', 'Leads Managment'),
                            'icon'=>'<i class="fa fa-bar-chart-o"></i>',
                            'url'=>['/addproperty-onepage-form/import'],
                            //'badge'=> TimelineEvent::find()->today()->count(),
                            'badgeBgClass'=>'label-primary',
                        ],
						[
						...
						[
                            ...
                            'url'=>['/websiteconfig/index'],
                          //  'badge'=> TimelineEvent::find()->today()->count(),
                          //  'badgeBgClass'=>'label-primary',
                        ],
						
						[
                            'label'=>Yii::t('backend', 'Agreement Managment'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-file"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Manage Agreements'), 'url'=>['/aggrementmgmt/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Agreement Logs'), 'url'=>['/agreement-log/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Agreement Config'), 'url'=>['/fifteenbells-config/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                             ]
                        ],
						[
                            'label'=>Yii::t('backend', 'Document Managment'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-file-word-o"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
							   ['label'=>Yii::t('backend', 'User Login As'), 'url'=>['/login-as-config/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                             
                                ['label'=>Yii::t('backend', 'Manage Documents'), 'url'=>['/documenttypenew/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                              ]
                        ],
                        [
						...
						[
                            'label'=>Yii::t('backend', 'Employee Management'),
                            'icon'=>'<i class="fa fa-graduation-cap"></i>',
                            'url'=>['/company-empb/index'],
                            'badge'=> \common\models\CompanyEmpb::find()->where(['employee_typeID'=>1])->count(),
                            'badgeBgClass'=>'label-primary',
                        ],[
						...
						[
                            ...
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Users'), 'url'=>['/user/index'], 'icon'=>'<i class="fa fa-users"></i>'],
                                ['label'=>Yii::t('backend', 'Users Profile'), 'url'=>['/user-profilenew/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Approve KYC Documents'), 'url'=>['/user-kycdocuments/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                             ],
							 'visible'=>Yii::$app->user->can('administrator'),
                        ],
                        
                        [
                            'label'=>Yii::t('backend', 'Users Roles'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-user-secret"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Admin'), 'url'=>['/admin'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                             ...
                             ['label'=>Yii::t('backend', 'Routing'), 'url'=>['/bellsroutings/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Role'), 'url'=>['/admin/role'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Assignment'), 'url'=>['/admin/assignment'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
