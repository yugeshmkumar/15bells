...
<div class="mt-element-step">
    ...
    <div class="row step-thin">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/updateb','id'=>$propid]) ?>">
        ...
        <div class="form-body">
           ...
           <!-- <div class="row">
            ...
            <div class="row" style="padding:30px 0px;">
				<div class="col-md-3">
					<p style="font-size: 15px;padding-top: 14px;color:#ffffff;">Stamp duty/ Registration</p>
				</div>
                <div class="col-md-5">
