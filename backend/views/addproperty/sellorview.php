...
<div id="viewpsambqwksukvveekmuzqtsimaccffmjkl" class="vvsambqwksukvveekmuzqtsblevbbff" onClick="">
...
//			],
                        ...
                        if ($data) {
                            return Html::a('<button class="btn btn-success" value = "" style="width:97px;cursor:default;" onclick = ""><b>' . $data['newcount'] . ' </b>Visitors</button>', $url = 'javascript:void(0)', [
...
<script>
    ...
    function togleShort(id) {
        ...
        $('#appenddata').html('');
        $('#headpropuser').html('Users Shortlisted Your property');
    ...
    function togleTransact(id) {
        ...
        $("#shortlist").modal('show');
        $('#appenddata').html('');
        $('#headpropuser').html('Users made transaction for your property');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#expecdata_" + id).append('<div class="col-md-12 veiw_property_description_div">' +
                        ...
                        '<span>' + ((obj.expected_rate == null) ? '________' : 'Rs ' + obj.expected_rate) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-4">' +
                        ...
                        '<span>' + ((obj.rate_negotiable == '') ? '________' : obj.rate_negotiable) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-4">' +
                        ...
                        '<div class="col-sm-10 veiw_property_description_div_inner">' +
                        '<b>Payment time</b><br>' +
                        '<span>' + ((obj.payment_time == null) ? '________' : obj.payment_time) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<span>' + ((obj.payment_time_negotiable == '0') ? '________' : obj.payment_time_negotiable) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-4">' +
                        ...
                        '<span>' + ((obj.loan_against_property == '') ? '________' : obj.loan_against_property) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-4">' +
                        ...
                        '<span>' + ((obj.all_dues_cleared == null) ? '________' : obj.all_dues_cleared) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-10 veiw_property_description_div_inner">' +
                        '<b>Vastu facing</b><br>' +
                        '<span>' + ((obj.vastu_facing == null) ? '________' : obj.vastu_facing) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="col-md-4">' +
                        ...
                        '<span>' + ((obj.loan_to_be_applied == null) ? '________' : obj.loan_to_be_applied) + '</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>');
