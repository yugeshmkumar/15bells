...
<div class="col-md-9">
	...
	<h3 class="visit_site caption-subject bold uppercase">TRANSACTION</h3>
		...
		<div class="col-md-6">	
			...
			<div class="col-md-4 text-center offline_src">
				...
				<p class="text_site emd_text">EMD</p>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="row emd_row" style="padding-top:60px;">
...
$(document).ready(function(){
	...
	$(".on_line").click(function(){
		...
		$(".emd_off").removeClass("hover_it");
		$(".emd_text").removeClass("hover_text");
		$(".offline_row").hide();
		$(".online_row").show();
		$(".emd_row").hide();
	});
	...
	$(".emd_line").click(function(){
		$(".emd_row").show();
		$(".offline_row").hide();
		$(".online_row").hide();
		$(".emd_off").addClass("hover_it");
		$(".emd_text").addClass("hover_text");
		$(".offline_icon").removeClass("hover_it");
		$(".off_text").removeClass("hover_text");
		$(".online_icon").removeClass("hover_it");
		$(".on_text").removeClass("hover_text");
