                       ...
                       <?php 
                        ...
                        if (empty($pic)) { ?>    
                          ...
                          <div class="item" data-slide-number="1">
                            <div class="center-block">
                              <span><img src="<?= Yii::getAlias('@archiveUrl').'/propertydefaultimg/gallery9.jpg';  ?>" class="center-block img-responsive"></span>
                            </div>
                          </div>
...
<!--                <div class="row hidden-xs hidden-sm" id="slider-thumbs">  
               ...
               <div class="col-md-12 div_upload_document_image text-right">
                   <a href="<?= Yii::getAlias('@frontendUrl')."/addproperty/additionals?idm=$viewid";  ?>">
                 <label class="btn-bs-file btn btn-lg ">
                      <i class="fa fa-upload" aria-hidden="true"></i> Upload Image
                      
                  </label></a>&nbsp;
                  <a href="<?= Yii::$app->getUrlManager()->getBaseUrl() ."/index.php/addproperty/additionals?idm=$viewid";  ?>">
                  <label class="btn-bs-file btn btn-lg ">
                      <i class="fa fa-upload" aria-hidden="true"></i> Upload Video
                      
                  </label></a>&nbsp;
                   <a href="<?= Yii::$app->getUrlManager()->getBaseUrl() ."/index.php/addproperty/documentss?id=$viewid";  ?>">
                  <label class="btn-bs-file btn btn-lg ">
