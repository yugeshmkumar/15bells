...
<div class="row">
    ...
    <div class="row step-thin">
       <a href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/updateinsellor','id'=>$modelid]) ?>">
        ...
        <a href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/documentss','id'=>$modelid]) ?>">
            <div class="col-md-3 bg-grey mt-step-col sell_add">
...
<?php endif; ?>
               <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase" style="font-size:20px !important;">UPLOAD DOCUMENTS</span>
                </div>
				</div> 
