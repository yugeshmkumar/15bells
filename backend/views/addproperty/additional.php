...
<div class="row">
    ...
    <div class="row step-thin">
     <a href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/updateinlessor','id'=>$modelid]) ?>">
...
<?php endif; ?>
			...
			<div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase" style="	color:#34495e !important;font-size:20px !important;">UPLOAD DOCUMENTS</span>
                </div>
			</div>
			<div class="row" style="border-top:3px solid #e5ac31;padding:20px;margin: 0 !important;
