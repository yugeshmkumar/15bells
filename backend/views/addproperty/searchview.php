...
<style type="text/css">
    ...
    .veiw_property_description_div .col-md-4{
        height:72px;
    }
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center" style="padding-top:30px;">
            <ul class="list_viw">
                ...
                <li><a href="javascript:void(0)" onclick="contactus(<?php echo $viewid ?>)" class="list_anchr">Contact Client</a></li>

            </ul>
        </div>

        <div class="col-md-12 document_s text-center">
            ...
            <div class="modal-dialog seller_exp modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Expectations</h4>
                    </div>
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            if ($role_id == 'seller') {
                                ...
                                <div class="row">
                                    <div class="col-md-6 veiw_property_description_div">
										<h3 class="sellr_ecp">Seller Expectation</h3>
                                        <?php if ($getsellerexpec->expected_rate != '' && $getsellerexpec->expected_rate != null) { ?>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-sm-2 text-center"><img src="<?= Yii::getAlias('@archiveUrl') . '/propertydefaultimg/bullet_tick.png'; ?>"> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 veiw_property_description_div_inner">
                            ...
                            <span><?php echo $featured_imaged; ?><span>
                                ...
                                <div class="modal fade" role="dialog" id="draggable2">
                                    <div class="modal-dialog seller_exp modal-lg" style="margin-top: 0px;top: 20%;">
                                        <div class="modal-content">
                                            <div class="modal-header greenHeader">
                                                <h4 class="modal-title textShadowHeading" style="color:#ea5460;">Contact Client</h4>
                                            </div>
                                        <div class="modal-body">
                        <div class="container-fluid">
                            <?php
                            ...
                            $user_id = $getseller->user_id;
                            if($user_id){
                                $userdetails = \common\models\User::find()->where(['id' => $user_id])->one();
                                }
                                ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 veiw_property_description_div">
				<h3 class="sellr_ecp">Client Details</h3>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 veiw_property_description_div_inner">
                                                    <b>Name</b><br>
                                                    <span><?php echo $userdetails->fullname; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 veiw_property_description_div_inner">
                                                    <b>Phone Number</b><br>
                                                    <span><?php echo $userdetails->username; ?></span>
                                                </div>
                                            </div>
                                        </div>
                               ...
                               <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
                                ...
                                var foodexpectid='';  
                                                             $(document).ready(function () {
                                                                ...
                                                                food = getParameterByName('user_id');
                                ...
                                <script>
                                    ...
                                    function directitnow(id) {
                                        ...
                                        $.ajax({
                                            url: "/backend/web/lesseeaction/directitnow",
