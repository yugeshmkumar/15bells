    ...
    <div class="portlet portlet-sortable">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                ...
                <span class="caption-subject bold uppercase">Requested Site Visit</span>
...
//                ],                   
                               ...
                               [
                                    ...
                                    if($visit_status_confirm == 'no'){                                        
                                        ...
                                        return 'Seen  '.Html::a('<button class="btn btn-basic" onclick="feedback('.$request_id.')" style="margin-left: 27px;padding: 5px;width: 94px;border: 1px solid; !important;"   value = "10"><i class="fa fa-commenting-o" aria-hidden="true"></i> Feedback</button>', $url = 'javascript:void(0)', []);
                                    }
                                       }
                                    ], 
