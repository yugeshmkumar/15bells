...
use common\models\MyExpectationsnew;

/**
 * MyExpectationsnewSearch represents the model behind the search form about `common\models\MyExpectationsnew`.
 */
class MyExpectationsnewSearch extends MyExpectationsnew
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query = MyExpectationsnew::find()->where(['user_id'=>$userid])->andwhere(['user_type'=>'lessee'])->andwhere(['is_active'=>'1']);
