...
class Usernew extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['email','username','fname'], 'required','message'=>"Blank Not Allowed."],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
			'fname'=>Yii::t('app', 'Sub-User Name'),
            'username' => Yii::t('app', 'Contact Number'),
            ...
            'email' => Yii::t('app', 'Contact E-mail'),
    ...
    {
        return $this->hasOne(\common\models\CompanyUsers::className(), ['subuser_id' => 'id']);
    }
}
