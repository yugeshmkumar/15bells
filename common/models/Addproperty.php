    ...
    public function rules()
    {
        return [
           ...
           // [['user_id', 'role_id', 'project_type_id', 'total_plot_area', 'expected_price', 'price_sq_ft', 'price_acres', 'buildup_area', 'carpet_area', 'total_floors', 'property_on_floor', 'floors_allowed_construction', 'bedrooms', 'bathrooms', 'balconies', 'parking'], 'integer'],
            [['asking_rental_price','maintenance_cost','annual_dues_payable','buildup_area','total_floors', 'bedrooms','bathrooms','balconies','servant_room','expected_price','membership_charge','no_of_similiar_shops','expected_rental'], 'integer','message' => '{attribute} is invalid.'],
