...
/**
 * BanknewSearch represents the model behind the search form about `common\models\Banknew`.
 */
class BanknewSearch extends Banknew
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        public function searches($params,$userid)
    {
        $query = Banknew::find()->where(['user_id'=>$userid]);
