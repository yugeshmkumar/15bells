...
/**
 * LessorExpectationsbinSearch represents the model behind the search form about `common\models\LessorExpectationsbin`.
 */
class LessorExpectationsbinSearch extends LessorExpectationsbin
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = LessorExpectationsbin::find()->orderBy('id desc')->where(['user_id'=>$userid]);
