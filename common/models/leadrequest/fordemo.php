...
<html lang="en">
    ...
    <head>
        ...
        <link href="../assets/admin/layout5/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="../assets/admin/layout5/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="../assets/admin/layout5/scripts/layout.min.js" type="text/javascript"></script>
        <script src="../assets/admin/layout/scripts/quick-sidebar.min.js" type="text/javascript"></script>
