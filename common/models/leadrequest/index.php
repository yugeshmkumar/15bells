...
<div class="portlet light ">
	...
	<?php if($pr && $_GET['status']){ ?>
	 ...
	 $searchModel = new  \common\models\LeadsSearch();
        //$dataProvider = $searchModel->searchbystatusndproduct(Yii::$app->request->queryParams,$_GET['status'],$pr);
		 // if($_GET['status'] == 1){
		 // $dataProvider = $searchModel->searchbyproduct(Yii::$app->request->queryParams,$_GET['status']);
		 // } else {
