...
?>
 ...
 <div class="portlet box blue">
                                            <div class="portlet-title">
                                                ...
                                                <div class="tools">
                                                   <a onclick="document.getElementById('viewpsambqwksukvveekmuzqtsimabbffr').style.display='none';document.getElementById('viewpsambqwksukvveekmuzqtsimaccffr').style.display='none'" style="cursor:pointer; color:#FFFFFF; font-weight:800;">x</a>
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="#">
                                                            ...
                                                            <div class="margiv-top-10">
																...
																<a onclick="document.getElementById('viewpsambqwksukvveekmuzqtsimabbffr').style.display='none';document.getElementById('viewpsambqwksukvveekmuzqtsimaccffr').style.display='none'" style="cursor:pointer; font-weight:800;" class="btn default">
                                                                Cancel </a>
                                                            </div>
...
function rejectleadaction(str){
         ...
         $.ajax({
				...
				url: "<?php echo Yii::$app->urlManager->createUrl(["leadrequest/rejectleadaction"]) ?>?leadid="+str,
