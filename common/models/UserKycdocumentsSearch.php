...
/**
 * UserKycdocumentsSearch represents the model behind the search form about `common\models\UserKycdocuments`.
 */
class UserKycdocumentsSearch extends UserKycdocuments
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = UserKycdocuments::find()->groupBy('userid');
