...
/**
 * AddpropertybackendSearch represents the model behind the search form about `common\models\Addpropertybackend`.
 */
class AddpropertybackendSearch extends Addpropertybackend
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Addpropertybackend::find()->orderBy('id desc');
