...
/**
 * MyprofilebackSearch represents the model behind the search form about `\common\models\Myprofile`.
 */
class MyprofilebackSearch extends Myprofile
{
    /**
     * @inheritdoc
     */
