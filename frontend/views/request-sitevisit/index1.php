			...
			<div class="col-md-6">
				<div class="row prop_list">
					<div class="col-md-12 p-0">
						<h5 class="prpr_hed mb-3 text-center">Documents</h5>
						<p class="pror_detl pl-3 pr-3"><span class="lite_clr">Description :</span> There is a very low level of trust with the Buyer’s / Lessee’s, when it comes</p>
						<p class="doc_pric text-center"><i class="fa fa-inr"></i> 3000</p>
						<p class="pror_detl pl-3 pr-3"><span class="lite_clr">Property ID :</span></p>
						<button class="btn btn-info full_wdth">Pay Now</button>
					</div>
				</div>
			</div>
		</div>
