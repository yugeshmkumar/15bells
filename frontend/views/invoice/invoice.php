...
<style>
@page{
    background-image:url("http://15bells.test/newimg/img/invoice.jpg");
...
<div class="invoice_body" style="width:100%;float:left;">
	<div class="full_width">
		...
		<div class="half_width" style="width:50%;float:left;text-align:right;font-family: 'Nunito Sans', sans-serif;">
			...
			<h3 class="head_fnt" style="color:#221d36;font-size:24px;"><?php echo $fullname; ?></h3>
		</div>
	</div>
    ...
    <div class="full_width">
    	<div class="half_width" style="width:60%;float:left;font-family: 'Nunito Sans', sans-serif;padding-top:70px;">
			<p class="small_p"><span style="color:#221d36;font-size:18px;font-family: 'Nunito Sans', sans-serif;">Invoice number: </span> <span class="color:#221d36;font-size:20px;font-family: 'Nunito Sans', sans-serif;font-weight:600;">#<?php echo $id; ?></span></p>
			<p class="small_p" style="padding-top:10px;"><span style="color:#221d36;font-size:18px;font-family: 'Nunito Sans', sans-serif;">Date:  </span> <span class="color:#221d36;font-size:20px;font-family: 'Nunito Sans', sans-serif;font-weight:600;"><?php echo $createdAt; ?></span></p>
		</div>
