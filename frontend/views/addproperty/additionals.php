        ...
        <div class="portlet portlet-fit ">
           ...
           <div class="portlet-body">
			...
			<!--<a href="<? //php echo Yii::$app->urlManager->createUrl(['lessor-expectations/create'])  ?>">-->
					...
					<a class="col-md-3 active_tab" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/additionals','idm'=>$modelid]) ?>" style="cursor:default !important;">
						<div class="bg-grey mt-step-col sell_add">
							<div class="mt-step-title uppercase font-grey-cascade add_det"><span>ADDITIONAL DETAILS</span></div>
							<div class="mt-step-content font-grey-cascade"><!--Complete your property check--></div>
						</div>
					</a>
					<a class="col-md-3 othr_tab no_bordr bordr_rds_rt" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/documentss','id'=>$modelid]) ?>" style="cursor:default !important;">
						<div class="bg-grey mt-step-col sell_add">
			 ...
			 <div class="caption add_prprt">
					...
					<div class="row">
						...
						<div class="col-md-9 upload_bar">
							...
							echo $form->field($model, 'featured_image')->widget(FileInput::classname(), [
								'options' => ['accept' => 'image/*','class'=>'imageclass','onClick'=>'ga("send", "event", "Addproperty sellor creates additionals image upload", "Addproperty sellor creates additionals image upload", "Addproperty sellor creates additionals image upload","Addproperty sellor creates additionals image upload")'],
							])->label(false);
							?>
               ...
               <div class="col-md-12 form-md-checkboxes has-success mrgin_top">
					<div class="row">
						...
						<div class="col-md-9 upload_bar">
							...
							echo $form->field($model, 'featured_video')->widget(FileInput::classname(), [
								'options' => ['accept' => 'video/*','class'=>'videoclass','onClick'=>'ga("send", "event", "Addproperty sellor creates additionals image upload", "Addproperty sellor creates additionals image upload", "Addproperty sellor creates additionals image upload","Addproperty sellor creates additionals image upload")'],
							])->label(false);
							?>
				...
				<div class="col-md-12 text-center" style="padding:20px 0 5px 0;">
					<a class="btn btn-info addi_butn"  id="additionalsdash" onclick="ga('send', 'event', 'Add property sellor creates additionalss gotodashboard', 'Add property sellor creates additionalss gotodashboard', 'Add property sellor creates additionalss gotodashboard','Add property sellor creates additionalss gotodashboard');" href="<?php echo Yii::$app->urlManager->createUrl(['/site/userdash']) ?>" >Go To Dashboard</a>


					 <a class="btn btn-info addi_butn" id="additionalsview"  onclick="ga('send', 'event', 'Add property  sellor creates additionals viewproperty', 'Add property  sellor creates additionals viewproperty', 'Add property  sellor creates additionals viewproperty','Add property  sellor creates additionals viewproperty');" href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/views', 'id' => $modelid]) ?>" >View Property</a>
