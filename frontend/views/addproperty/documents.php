...
<!--<a href="<? //php echo Yii::$app->urlManager->createUrl(['lessor-expectations/create'])  ?>">-->
        ...
        <a class="col-md-3 othr_tab" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/additional', 'idm' => $modelid]) ?>" style="cursor:default !important;">
            <div class="bg-grey mt-step-col sell_add">
...
<?php } ?>
    ...
    <div class="row sellr_proprty mb-4">
...
echo FileInput::widget([
    'name' => 'documentfiles1',
    'id' => 'documentfiles1',
    //'onClick' => 'ga("send", "event", "Addproperty create getcount submit", "Addproperty create getcount submit", "Addproperty create getcount submit","Addproperty create getcount submit")',
    'options' => ['multiple' => false, 'accept' => 'pdf/*','class'=>'documentsfiles','onclick' => 'ga("send", "event", "Add property create documents image", "Add property create documents image", "Add property create documents image","Add property create documents image")'],
    'pluginOptions' => [
...
<?php  if($status == 'pending'){
                         ?>
            <a id="publish" type="button" onclick="publishprop(),ga('send', 'event', 'Addproperty create documents publish button', 'Addproperty create documents publish button', 'Addproperty create documents publish button','Addproperty create documents publish button');" class="btn btn-info addi_butn pub_documents"  href="#" >Publish Property</a>
            <?php }else { ?>
            ...
            <a class="btn btn-info addi_butn publes_viewproperty" onclick="ga('send', 'event', 'Addproperty create documents viewproperty', 'Addproperty create documents viewproperty', 'Addproperty create documents viewproperty','Addproperty create documents viewproperty');"  href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/views', 'id' => $modelid]) ?>" > View Property</a>
