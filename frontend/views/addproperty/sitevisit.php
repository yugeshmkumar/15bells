...
<div class="col-md-9">
    ...
    <div class="row">
        <h3 class="visit_site">SITE VISIT</h3>
        <div class="col-md-10" style="padding-top:40px;">
            ...
            <div class="col-md-6 text-center online_src">
                <a href="javascript:void(0)" class="on_line">
                    <div class="online_icon">
                        <p><img src="<?= Yii::$app->request->baseUrl . '/dashimages/smartphone.png' ?>" width="80"></p>
                    </div>
                    <p class="text_site on_text">Online</p>
                </a>
            </div>
            <div class="col-md-6 text-center offline_src">
                <a href="javascript:void(0)" class="off_line"><div class="offline_icon">
                    ...
                    <p class="text_site off_text">Offline</p>
                </a>
            </div>
        </div>
    </div>
