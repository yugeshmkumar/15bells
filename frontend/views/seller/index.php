...
$this->registerLinkTag(['rel' => 'canonical', 'href' => 'https://www.15bells.com/seller/']); 
						...
						<div class="row add_price">
							<div class="col-md-12 property_area">
									<div class="col-md-8 expected_price">
                                        ...
                                        <input type="text" onkeyup="word.innerHTML=convertNumberToWords(this.value)"  name="Addproperty[expected_price]" class="form-control input_desgn exp_price input_number" placeholder="Enter Amount" id="addproperty-expected_price">
                                        <p id="word"></p>
                                        </div>
                                       							</div>
									</div>
