...
<div class="container text-center pad50">
					    ...
					    <div class="row">
							...
							<p class="add_buttn"><a href="#" class="button_add add_prop sellr_add" onclick="ga('send', 'event', 'Seller Add Property', 'Seller Add Property', 'Seller Add Property','Seller Add Property')">Add your property</a><a onclick="ga('send', 'event', 'Seller How It Works', 'Seller How It Works', 'Seller How It Works','Seller How It Works')" href="#" class="button_add how_wrk seller_wrks">How it works?</a></p>
			...
			<div class="row">
				<div class="addprop_form row">
					<h3 class="property_head"><span>Add your property</span></h3>
						...
						<button id="onebutton" class="button_add sellr_proprt" onclick="ga('send', 'event', 'Seller Add Property Button', 'Seller Add Property Button', 'Seller Add Property Button','Seller Add Property Button')">Submit</button>
					        </div>
				</div>
