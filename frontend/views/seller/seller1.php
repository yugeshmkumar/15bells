...
<style>
	...
	<!--======Second Section Starts========-->
			...
			<div class="container-fluid" id="seller_sec">
				
				<div class="row" style="height:250px;"></div>
					<video class="video_p" poster="" id="bgvid" playsinline autoplay muted loop>
					<source src="<?= Yii::$app->request->baseUrl . '/frontvideo/case3d_homepage_video_final.mp4' ?>" type="video/mp4">
  ...
  <div class="container" style="margin-top:180px;">
    <div class="row">
				<div class="col-md-12"> 
					<p class="section_p text-center" style="color:#000000 !important;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				</div>
               <div class="col-md-12">
                              ...
                              <div class="carousel-inner">
                                ...
                                <div class="active item">
                                            <div class="sliderheading animated bounceInRight">
                                                <p><br><span class="heading1">Direct Genuine </span> <br> customers</p> 
                                              </div>
                                </div>
                                        <div class="item">
                                            <div class="sliderheading animated bounceInRight">
                      
                                                <p><br><span class="heading2">Price it right and </span>let the market chase <span class="heading2">you</span></p>
                                              </div>
                                </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <p><br><span class="heading3">Payment directly <br>into your </span>account</p> 
                                          </div>
                                </div>
                              </div>
                            </div>
 ...
 <ol class="carousel-indicators">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
       <img src="<?= Url::to('@web/img')?>/slider/seller/img-01.jpg" class="img-responsive" alt="..." title="...">
            ...
            <div class="col-md-12">
                         ...
                         <div class="col-md-6">
                           <p class="animated bounceInUp align-center">
                                    one to one transaction with <span class="heading1">property owner</span>                              
                          </p>
  ...
  <div class="item">
       <img src="<?= Url::to('@web/img')?>/slider/seller/img-02.jpg" class="img-responsive" alt="..." title="...">
    ...
    <div class="carousel-caption animated bounceInDown">
        <div class="container">
            ...
            <div class="col-md-12">
                         ...
                         <div class="col-md-6">
                           <p class="animated bounceInUp align-center">
                                    real time <span  class="heading2">virtual</span> <br>meetings                           
                          </p>
    ...
    <div class="item">
       <img src="<?= Url::to('@web/img')?>/slider/seller/img-03.jpg" class="img-responsive" alt="..." title="...">
    ...
    <div class="carousel-caption animated bounceInDown">
        <div class="container">
            ...
            <div class="col-md-12">
                         ...
                         <div class="col-md-6">
                           <p class="animated bounceInUp align-center">
                                    online transfer of <span  class="heading3"><br>money</span>                              
                          </p>
      ...
      <div class="col-md-12 post" style="margin: 40px 0px 40px 0px;">
        ...
        <div class="col-md-12 post" style="margin: 0px 0px 40px 0px;">
          <div class="col-md-6">
                    <div class="seller_steps">
                      <img src="<?= Url::to('@web/img') ?>/steps.jpg" class="img-responsive"> -
                        <div class="col-md-4 col-sm-4 text-center seller_main_div">
                            <div class="seller_step1">
                                <img src="<?= Url::to('@web/img') ?>/step1.png" alt="..." title="..." class="seller_step_img1">
                                ...
                                <span style="text-align: center; padding-left: 50px;">STEP 2</span><br>--
                                   <p class="overley_text">A seller, your first step will be to tag your property on Google Map.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 text-center seller_main_div">
                            <div class="seller_step2">
                                <img src="<?= Url::to('@web/img') ?>/step2.png" alt="..." title="..." class="seller_step_img2">
                                <div class="overlay_img">
                                <!--<span style="text-align: center; padding-left: 50px;">STEP 2</span><br>--
                                ...
                                <b style="text-align: center; font-size: 11px;"><span style="color: #fcc82b; border-bottom: 0px;">Discover/ </span>Be Discovered</b><br>
                                   <p class="overley_text">Once you have tagged your property which you want to sell, you will then search for buyer or vice-versa.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 text-center seller_main_div">
                            <div class="seller_step3">
                                <img src="<?= Url::to('@web/img') ?>/step3.png" alt="..." title="..." class="seller_step_img3">
                                <div class="overlay_img">
                                <!--<span style="text-align: center; padding-left: 50px;">STEP 2</span><br>-
                                ...
                                <b style="text-align: center; font-size: 11px;"><span style="color: #e23a59; border-bottom: 0px;">Close the deal in</span> the Virtual Room</b><br>
                                   <p class="overley_text">Once the buyer has finalized the property, you will be taken to the virtual room where the deal will be finalized between the two parties.</p>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <div class="col-md-6 col-md-6">
            <div class="vedio">
                <a href="#" data-toggle="modal" data-target="#videoModal" data-theVideo="https://www.youtube.com/embed/2OM4WRSDzxQ">
                
                <img src="<?= Url::to('@web/img')?>/vedio_seller.jpg" class="img-responsive">
    ...
    <div class="row">
      <div class="col-md-12 post" style="margin: 40px 0px 40px 0px;">
       <div class="text-center">
          <h2>FAQ'S</h2>
           <?php
      $arrgetfaqs = common\models\activemode::getpublishedfaqs("seller");
      ?>
