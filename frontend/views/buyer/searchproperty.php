...
<div class="row">
  <div class="col-md-12 col-sm-12">
    ...
    <li class="active"><button data-toggle="tab" href="#residential" class="btn btn-default" type="submit">RESIDENTIAL</button></li>
    <li><button data-toggle="tab" href="#commercial" class="btn btn-default" type="submit">COMMERCIAL</button></li>
    <li><button data-toggle="tab" href="#other" class="btn btn-default" type="submit">OTHER</button></li>
  </ul>
