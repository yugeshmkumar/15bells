    ...
    <?php echo GridView::widget([
        ...
        'columns' => [
            ...
            'value' => function($data) {
                ...
                return Html::a('<button class="btn btn-default"   id="propertyidprop"  data-html="true"  style="border-color:#0fd8da;border:1px solid;" >View Shortlist</button>', $url = '/lesseeaction/index1', [
