...
if(!isset($_SESSION)) 
    ...
    if(isset($_SESSION['locationss'])){   
        ...
        // get a session variable. The following usages are equivalent:
         $getlocality = $_SESSION['locationss'];     
      ...
      <div class="row">
							 <div id="firststep" class="p-0 col-md-6 col-sm-10 animated bounce">
								...
								<div class="col-md-2 p-0 search_search_btn_div animated bounce" id="serch_stp"> 
                                    ...
                                    <button type="button" id="searches" value="Geocode" onclick="getpolymy();ga('send', 'event', 'Lesseaction Search Search Button', 'Lesseaction Search Search Button', 'Lesseaction Search Search Button','Lesseaction Search Search Button');" class="btn btn-primary search_prop_button_lessee animated bounce">
                             <span style="position:relative;"><i class="fa fa-search search1"></i> <span style="position:relative;bottom:6px;">Search</span></span>
								...
								<div class="col-md-4 text-center expectation_delet_btn_div">
									  <span class="exp_ect">
											<?= Html::button('Create Expectations', ['value' => Url::to('/lessor-expectations/creates'), 'class' => 'btn btn-success expectation_div_button', 'id' => 'modalButton','onclick'=>"ga('send', 'event', 'Lesseaction Search Create Expectations', 'Lesseaction Search Create Expectations', 'Lesseaction Search Create Expectations','Lesseaction Search Create Expectations')"]) ?>
...
<!--				<div class="col-md-3 ">
    ...
    <div class="btn-group areaRange" style="width:100%;">
      ...
      <div class="dropdown-menu ddRange" role="menu" style="width: 295px;padding-top: 12px;top:114px !important;">
        <div class="rangemenu">
...
<!--				<div class="col-md-1 col-sm-2 text-center another_search_detail_4_div">
        ...
        <div class="row search_map_row" style="position:relative;">
            <div class="col-md-3 col-sm-2 search_delet_btn_div pl-5">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div id="searchtab">
                    <div class="container"  id="searchtab">
						...
						<div class="col-md-12 expect_form">
                            <div class="row" style="margin:0;">
                                <div class="col-md-9 serch_rslt">
								  ...
								  <div class="buyit col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <select id="sortby" class="form-control pull-right" onclick="ga('send', 'event', 'Lesseaction Search Select Sorting', 'Lesseaction Search Select Sorting', 'Lesseaction Search Select Sorting','Lesseaction Search Select Sorting')">
                            ...
                            <div class="row " style="margin:0;" id="similiarrow">
                                 ...
                                 <div class="caption font-green-sharp exp_titl sellr_proprty col-md-12 mt-5 pl-4 pt-4">
            ...
            if (town == '' && sector == '') {
                ...
                if (getsearchlocation != '' || shapes != '') {
									...
									'<div class="row prop_list">'+
										...
										'<div class="col-md-12 text-center bordr_lw">'+
											...
											((this.request_for == 'Instant') ?
												'<a class="col-md-4 col-xs-4 app_rch appr_cursr" href="javascript:void(0)" onclick="directitnow(' + this.id + ');"><div>'+
													'<span class="app_rch">Instant Approach</span>'+
												'</div></a>'
												:
										 ((this.request_for == 'bid') ?
										 '<a class="col-md-4 col-xs-4 app_rch lessitevisit" href="javascript:void(0)" onclick="bititnow(' + this.id + ');"><div>'+
													'<span class="app_rch">Bit it Now</span>'+
												'</div></a>'
												: ''
									   )) +						
												
												'<a class="col-md-4 col-xs-4 brdr_b app_rch lessitevisit" href="javascript:void(0)" id="' + this.id + '" onclick="getfreevisit(this.id)"><div>'+
													'<span class="app_rch">'+
													(this.county > 0 ? 'Site Visited': 'Book Site Visit') +
													'</span>'+
												'</div>'+
												'</a>'+
												'<a class="col-md-4 col-xs-4 app_rch lesshortlist" href="javascript:void(0)" id="' + this.id + '" onclick="getchecki(this.id);"><div>'+
                    ...
                    if (shapes == 'polygon') {
                        ...
                        ndata = {location: getsearchlocation, shapes: shapes, newpath: newpath, area: getexpectationID, town: town, sector: sector, areamin: areamin, areamax: areamax, pricemin: pricemin, pricemax: pricemax, proptype: proptype, propbid: propbid};
                    ...
                    if (shapes == 'circle') {
                        ...
                        $.ajax({
                            type: "POST",
                            url: 'mapproperty1',
                            data: {location: getsearchlocation,center: centercoordinates, totalradius: totalradius, shapes: shapes, town: town, sector: sector, area: getexpectationID, town:town, sector:sector, areamin: areamin, areamax: areamax, pricemin: pricemin, pricemax: pricemax, proptype: proptype, propbid: propbid},
                            success: function (data) {
                                // alert(data);
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $.each(obj, function (index) {
                                    ...
                                    var content = 'A very good ' + this.typename + ' availabale for lease in ' + this.city + ' with Plot area ' + this.total_plot_area + ' sqft, Superbuiltup ' + this.buildup_area + ' sqft, It is a ' + this.furnished_status + ' property suitable for any kind of ' + this.typename + ', For more details or Site Visit , please Contact Us..';
                                    var imaged = $.trim(this.featured_image);
                                    var c = content.substr(0, showChar);
                                    var h = content.substr(showChar - 1, content.length - showChar);
                                    var html = '<span onclick="propdetails(' + this.id + ')">' + c + '</span><span class="moreellipses" style="display:inline">' + ellipsestext + '&nbsp;</span><span class="morecontent"><span onclick="propdetails(' + this.id + ')" class="ajamore" style="display:none">' + h + '</span>&nbsp;&nbsp;<a onclick="getmoredata(this.id)" href="javascript:;" id="morelinks_' + this.id + '" class="morelinks ">' + moretext + '</a></span>';
        ...
        $('#sortby').change(function () {
            ...
            if (sortvar != '') {
                ...
                $.each(obj, function () {
                    ...
                    var content = 'A very good ' + this.typename + ' availabale for rent/lease in ' + this.city + ((this.total_plot_area != '0') ? 'with Plot area ' + this.total_plot_area + ' sqft,' : '' ) + ' with Superbuiltup ' + this.buildup_area + ' sqft, It is a ' + this.furnished_status + ' property suitable for any kind of ' + this.typename + ', For more details or Site Visit , please Contact Us..';
                    var imaged = $.trim(this.featured_image);
                    var c = content.substr(0, showChar);
                    var h = content.substr(showChar - 1, content.length - showChar);
                    ...
                    var mathceildist = Math.ceil(this.distance);
                     ...
                     $('#getprop').append('<div class="col-md-6 chirag">'+
										'<div class="row prop_list">'+
											...
											'<h5 class="prpr_hed mb-3">' +  this.typename +' availabale for rent in '+ this.city  + '</h5>'+
											'<p class="pror_detl"><span class="lite_clr">Locality :</span> '+ this.locality +'</p>'+
											((ferit == 1 ? '<p class="pror_detl"><span class="lite_clr"><i class="fa fa-map-marker" aria-hidden="true"></i> Locality :  </span>' + mathceildist + ' km </p>' : '')) +
											'<p class="pror_detl"><span class="lite_clr">Highlight :</span> On Sale / ' + this.age_of_property + ' Years Old'+ (( this.furnished_status == '') ? '' : '/ '+ this.furnished_status)+ (( this.property_on_floor == null) ? '' : ' / ' + this. property_on_floor + 'th Floor') + (( this.total_floors == null) ? '' : ' (out of ' + this.total_floors +')')+'</p>'+
											'<p class="pror_detl"><span class="lite_clr">Description: </span>'+ html +'</p>'+
											'<p class="mt-3 mb-4">'+
											'<a onclick="viewproperty(' + this.id + ');" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/viewsearch?id=']) ?>'+this.id+'&expecidl='+getexpectationID+'" target="_blank" class="more_detail">More Details</a>'+
											...
											'<div class="col-md-12 text-center bordr_lw">'+
												'<div class="row">'+
												((this.request_for == 'Instant') ?
													'<a class="col-md-4 col-xs-4 app_rch appr_cursr" href="javascript:void(0)" onclick="directitnow(' + this.id + '); ga("send", "event", "Buyeraction Search Property InstantApproach", "Buyeraction Search Property InstantApproach", "Buyeraction Search Property InstantApproach","Buyeraction Search Property InstantApproach");"><div>'+
														'<span class="app_rch">Instant Approach</span>'+
													'</div></a>'
													:
											 ((this.request_for == 'bid') ?
											 '<a class="col-md-4 col-xs-4 app_rch lessitevisit" href="javascript:void(0)" onclick="bititnow(' + this.id + '); ga("send", "event", "Buyeraction Search Property InstantApproach", "Buyeraction Search Property InstantApproach", "Buyeraction Search Property InstantApproach","Buyeraction Search Property InstantApproach");"><div>'+
														'<span class="app_rch">Bit it Now</span>'+
													'</div></a>'
													: ''
										   )) +						
													
													'<a class="col-md-4 col-xs-4 brdr_b app_rch lessitevisit" href="javascript:void(0)" id="' + this.id + '" onclick="getfreevisit(this.id); ga("send", "event", "Buyeraction Search Book Site Visit", "Buyeraction Search Book Site Visit", "Buyeraction Search Book Site Visit","Buyeraction Search Book Site Visit");"><div>'+
														'<span class="app_rch">'+
														(this.county > 0 ? 'Site Visited': 'Book Site Visit') +
														'</span>'+
													'</div>'+
													'</a>'+
													'<a class="col-md-4 col-xs-4 app_rch lesshortlist" href="javascript:void(0)" id="' + this.id + '" onclick="getchecki(this.id); ga("send", "event", "Buyeraction Search property Shortlist", "Buyeraction Search property Shortlist", "Buyeraction Search property Shortlist","Buyeraction Search property Shortlist");"><div>'+
														'<span class="app_rch">Shortlist</span>'+
													'</div></a>'+
												'</div>'+
											'</div>'+
...
//                                                                    ' <img src="<?= $_SERVER['DOCUMENT_ROOT'] . '/newbells/archive/web/propertydefaultimg/' ?>'+imaged+'" alt="..."  title="....">' +
    ...
    function getfreevisit(id) {
        ...
        ga("send", "event", "Lesseeaction Search Property Sitevisit", "Lesseeaction Search Property Sitevisit", "Lesseeaction Search Property Sitevisit","Lesseeaction Search Property Sitevisit"); 
        var getexpectationID = $('#expectid').val();
    ...
    function getchecki(id) {
        ...
        ga("send", "event", "Lesseeaction Search Property Shortlist Button", "Lesseeaction Search Property Shortlist Button", "Lesseeaction Search Property Shortlist Button","Lesseeaction Search Property Shortlist Button");
...
//                                                                '<label style="padding-left:115px;"><input  class="className" type="checkbox" id="' + this.id + '" onclick="getchecki5(this.id)"><span class="short_list">Shortlist</span></label>' +
    ...
    function directitnow(id) {
        ...
        ga("send", "event", "Lesseeaction Search Property Instant Approach", "Lesseeaction Search Property Instant Approach", "Lesseeaction Search Property Instant Approach","Lesseeaction Search Property Instant Approach");
    ...
    function viewproperty1(id) {
        ...
        ga("send", "event", "Lesseeaction Search Property More details", "Lesseeaction Search Property More details", "Lesseeaction Search Property More details","Lesseeaction Search Property More details");
