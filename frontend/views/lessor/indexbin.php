        ...
        <div class="container">
           ...
           <p> <button class="btn btn-default" type="submit">LIST PROPERTY</button></p>
            ...
            <div class="sliderheading animated bounceInRight">
              <h2><span class="heading1">numerous tenants</span> with a single click.</h2> 
            </div>
      ...
      <div class="carousel-caption">
        <div class="container">
           ...
           <p> <button class="btn btn-default" type="submit">LIST PROPERTY</button></p>
            ...
            <div class="col-md-6">
            <div class="sliderheading animated bounceInRight">
              <h2><span class="heading2">get the best brands</span> signed up for your <span class="heading2">hard earned investment</span></h2> 
            </div>
                         <div class="collapse" id="collapseExample">
                          <div class="well">
                          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.9538023110617!2d77.0698003146755!3d28.450808982489907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d18ecedcb986d%3A0x9e817517fa433ab9!2sENCRISS.com!5e0!3m2!1sen!2sin!4v1490011480119" width="480" height="280" frameborder="0" style="border:0" allowfullscreen></iframe>
      ...
      <div class="carousel-caption">
        <div class="container">
           ...
           <p> <button class="btn btn-default" type="submit">LIST PROPERTY</button></p>
            ...
            <div class="col-md-6">
            <div class="sliderheading animated bounceInRight">
              <h2><span class="heading3">Real time transaction with the end user, no</span> more wasting of time</h2> 
            </div>
                         <div class="collapse" id="collapseExample">
                          <div class="well">
                          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.9538023110617!2d77.0698003146755!3d28.450808982489907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d18ecedcb986d%3A0x9e817517fa433ab9!2sENCRISS.com!5e0!3m2!1sen!2sin!4v1490011480119" width="480" height="280" frameborder="0" style="border:0" allowfullscreen></iframe>
          ...
          <div class="col-md-6">
            <div class="steps">
             ...
             <div class="col-md-4 col-sm-4 text-center">
               <div class="step1">
                 <img src="<?= Url::to('@web/img')?>/step1.png" alt="..." title="...">
               </div>
             </div>
              <div class="col-md-4 col-sm-4 text-center">
                <div class="step2">
                  <img src="<?= Url::to('@web/img')?>/step2.png" alt="..." title="...">
                </div>
              </div>
               <div class="col-md-4 col-sm-4 text-center">
                 <div class="step3">
                   <img src="<?= Url::to('@web/img')?>/step3.png" alt="..." title="...">
                 </div>
               </div>
            </div>
          </div>
