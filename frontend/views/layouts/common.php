...
-->                                <li>
                               ...
                               <!-- <li>
                                ...
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['lesseeaction/index1']) ?>">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                       ...
                       <?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>"><?php } ?>
                                ...
                                <!--<li>
                                    <a href="">
                                        <i class="fa fa-credit-card"></i> My Expectations 
										</a>
                                </li>-->
                                <li>
...
<!--<li class="nav-item">
						 ...
						 <li class="nav-item">
                            <a href="<?php echo Yii::$app->urlManager->createUrl(['lesseeaction/index']) ?>" class="nav-link nav-toggle">
                              ...
                              <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['lesseeaction/index']) ?>" class="nav-link">As Lessee</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['lesseeaction/index1']) ?>" class="nav-link">As Buyer</a>
                                </li>
                            </ul>
