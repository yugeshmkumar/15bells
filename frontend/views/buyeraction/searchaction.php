    ...
    <a href="<?php echo Yii::$app->urlManager->createUrl(['site/userdash']) ?>">Home</a>
				...
				<div class="col-md-2 search_search_btn_div animated bounce" id="serch_stp"> 
                                    ...
                                    <button type="button" id="newsearches" value="Geocode" onclick="getpolymynew();" class="btn btn-primary search_prop_button_lessee animated bounce">
                                        <span style="position:relative;bottom:3px;"><i class="fa fa-search search1"></i> <span style="position:relative;bottom:6px;">Search</span></span>
                                    </button>
                                </div>
							   <div class="col-md-4 text-center expectation_delet_btn_div">
                                   <span class="exp_ect"> <?= Html::button('Create Expectations',['value'=>Url::to('/sellor-expectations/updated?id='.$expectID.''),'class'=>'btn btn-success expectation_div_button','id'=>'modalButton']) ?>
...
<script type="text/javascript">
    ...
    $("#searches,#newsearches").click(function() {
    $('html, body').animate({
                                          ...
                                          $.ajax({
                                               ...
                                               $('#search-pro').css("display","block");
                                                       ...
                                                       $.each(obj, function (index) {
                                                        ...
                                                        bermudaTriangles = new google.maps.Polygon({
...
ndata = {location:getsearchlocation,center:centercoordinates,latcenter:latt,longcenter:longg,totalradius:totalradius,town:town,sector:sector,area:savesearchid,areamin:areamin,areamax:areamax,pricemin:pricemin,pricemax:pricemax,proptype:proptype,propbid:propbid}; 
				...
				'<div class="row prop_list">'+
					...
					'<p class="pror_detl"><span class="lite_clr">Description: </span>'+ html +'</p>'+
					'<p class="mt-3 mb-4">'+
					'<a onclick="viewproperty(' + this.id + '); ga("send", "event", "Buyeraction Search Property Moredetails", "Buyeraction Search Property Moredetails", "Buyeraction Search Property Moredetails","Buyeraction Search Property Moredetails");" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/viewsearch?id=']) ?>'+this.id+'&expecidl='+savesearchid+'" target="_blank" class="more_detail">More Details</a>'+
					'</p>'+
					'</div>'+
					'<div class="col-md-12 text-center pt-1 pb-3">'+
						'<div class="row">'+
...
//
				...
				'<div class="row prop_list">'+
					...
					'<p class="pror_detl"><span class="lite_clr">Description: </span>'+ html +'</p>'+
					'<p class="mt-3 mb-4">'+
					'<a onclick="viewproperty(' + this.id + '); ga("send", "event", "Buyeraction Search Property Moredetails", "Buyeraction Search Property Moredetails", "Buyeraction Search Property Moredetails","Buyeraction Search Property Moredetails");" href="<?php echo Yii::$app->urlManager->createUrl(['addproperty/viewsearch?id=']) ?>'+this.id+'" target="_blank" class="more_detail">More Details</a>'+
					'</p>'+
					'</div>'+
					'<div class="col-md-12 text-center pt-1 pb-3">'+
						'<div class="row">'+
				...
				'<div class="row prop_list">'+
					...
					'<div class="col-md-12 text-center pt-1 pb-3">'+
						'<div class="row">'+
							...
							'</div>'+
							'<div class="col-md-4 col-xs-4">'+
								'<span class="lite_clr"><i class="fa fa-building-o"></i> '+ this.county1 +'</span>'+
							'</div>'+
						'</div>'+
					'</div>'+
					'<div class="col-md-12 text-center bordr_lw">'+
