						...
						<div class="col-md-9">
							<div class="row">
								...
								<div class="col-md-6 company_overview property_manage">
									...
									<p class="label_name"><?php echo $datas['locality'] ?></p>
								</div>
								<div class="col-md-12 unit_details">
									<ul class="details_unit col-md-12">
										...
										<p class="details_name"><?php echo $datas['expected_price'] ?></p>
										</li>
										<li class="col-md-3">
								...
								<div class="col-md-12 progress_bar">
									<p class="text-right process_continue"><a id="<?php echo $datas['id']; ?>" onclick="sitevisitproperties(this.id);" class="property_process">Schedule Visit </a>
