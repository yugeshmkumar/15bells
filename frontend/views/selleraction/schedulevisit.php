...
?>
                                    ...
                                    <div class="mt-element-step">
                                        ...
                                        <div class="row step-thin">
                                          <a href="<?php echo Yii::$app->urlManager->createUrl(['selleraction/schedulevisit']) ?>">
                                            ...
                                            </div></a><a href="<?php echo Yii::$app->urlManager->createUrl(['selleraction/schedulevisit']) ?>">
 ...
 <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class'=>"form-horizontal"]]) ?>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="md-checkbox-inline">
                                                        <div class="md-checkbox">
                                                            <input type="checkbox" id="checkbox1_3" name="checkbox1_3" value="Sale" class="md-check" checked disabled>
                                                            <label for="checkbox1_3">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Sale </label>
                                                        </div>
                                                        <!--<div class="md-checkbox">
                    ...
                    <select class="form-control" name="propertytye" id="propertytype" onChange="focalphy()" placeholder="" required>
							...
							<?php $arrfindallpropertytype = \common\models\PropertyType::find()->where(['undercategory'=>"Residential",'isactive'=>1])->all(); ?>
                                 <?php foreach($arrfindallpropertytype as $propertytype) {  ?>
								<option value="<?php echo  $propertytype->id ?>"><?php echo  $propertytype->typename ?></option>
							<?php } ?>
...
<?php $arrfindallpropertytype2 = \common\models\PropertyType::find()->where(['undercategory'=>"Others",'isactive'=>1])->all(); ?>
                                 <?php foreach($arrfindallpropertytype2 as $propertytype2) {  ?>
								<option value="<?php echo  $propertytype2->id ?>"><?php echo  $propertytype2->typename ?></option>
							<?php } ?>
