...
<div class="row" id="imghide">
 ...
 <img src="<?= Yii::$app->request->baseUrl .'/loader.gif' ?>" class="img-responsive newimg" >   
</div>    
...
<?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>"><?php } ?>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="expectations">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/sellor-expectations/sellor']) ?>"> <div class="dashboard-stat2 "style="background:rgba(219, 226, 253, 0.61);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">
                            <span data-counter="counterup" data-value="567"></span>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/creates']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/sellorview']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/sellor']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
...
<?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>"><?php } ?>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="expectations">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/sellor-expectations/buyer']) ?>"> <div class="dashboard-stat2 "style="background:rgba(219, 226, 253, 0.61);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">
                            <span data-counter="counterup" data-value="567"></span>
                        </h3>
                        <small>BUYER EXPECTATIONS</small>
                    </div>
                    <div class="icon">
                        <i class="icon-basket"style="color:#372ae4"></i>
                    </div>
...
<?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>"><?php } ?>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="expectations">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/lessor-expectations/lessor']) ?>"> <div class="dashboard-stat2 "style="background:rgba(219, 226, 253, 0.61);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">
                            <span data-counter="counterup" data-value="567"></span>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/create']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/lesview']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="banks">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/addproperty/lessor']) ?>"><div class="dashboard-stat2 " style="background:rgba(227, 211, 255, 0.68);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">
                            <span data-counter="counterup" data-value="276"></span>
...
<?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>"><?php } ?>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="expectations">
        <a href="<?php echo Yii::$app->urlManager->createUrl(['/lessor-expectations/lessee']) ?>"> <div class="dashboard-stat2 "style="background:rgba(219, 226, 253, 0.61);">
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">
                            <span data-counter="counterup" data-value="567"></span>
                        </h3>
                        <small>LESSEE EXPECTATIONS</small>
                    </div>
                    <div class="icon">
                        <i class="icon-basket"style="color:#372ae4"></i>
                    </div>
...
<script>
    ...
    $(document).ready(function () { 
       // alert();
      //  $( "ul.dash_sidenav li:nth-child(2)").addClass("active");
