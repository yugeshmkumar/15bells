			...
			<div class="col-md-5 col-md-offset-3 text-center select_catg">
				...
				<div class="container">
					<div class="col-md-12 property_typess">
							...
							<a href=""><div class="col-md-3 col-xs-6 ware_house">
...
<div class="container-fluid featured_section">
	<div class="container">
		<div class="row">
			<div class="col-md-6 no_pad">
				<h6 class="trans_head">We Got <br>Featured</h6>
