				...
				<div class="tab-content personal_details">
					  <div id="home" class="tab-pane row fade in active">
						<div class="col-md-12">
							...
							<div class="row">
								<h3 class="current_role">Current Role <i class="fa fa-info-circle info_icon" data-placement="bottom" data-toggle="tooltip" title="Switch roles between a buyer, seller, leaser or lessee in just a few clicks. No need to create another account. Sort multiple requirements under one profile." aria-hidden="true"></i></h3>
