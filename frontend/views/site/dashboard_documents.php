...
use yii\db\Query;
$this->title = 'Dashboard Documents';
...
<?php Modal::end(); ?>
 	<div class="col-md-9">
		...
		<div class="row">
			...
			<h3 class="all_expctatns">Documents</h3>	
				<div class="col-md-3 text-center padding_t">
					<a href="<?php echo Yii::$app->urlManager->createUrl(['/media-files-config/seller']) ?>"><div class="expectation_detail">
						<p class="numbr_expct"><img src="<?= Url::to('@web/dashimages') ?>/my_document.png"></p>
						<p class="expct_name">Seller Documents</p>
					</div></a>
				</div>
				<div class="col-md-3 text-center padding_t">
					<a href="<?php echo Yii::$app->urlManager->createUrl(['/common/documents']) ?>"><div class="expectation_detail ">
						<p class="numbr_expct"><img src="<?= Url::to('@web/dashimages') ?>/my_document.png"></p>
						<p class="expct_name">Buyer Documents</p>
					</div></a>
				</div>
				<div class="col-md-3 text-center padding_t">
					<a href="<?php echo Yii::$app->urlManager->createUrl(['/media-files-config/lessor']) ?>"><div class="expectation_detail">
						<p class="numbr_expct"><img src="<?= Url::to('@web/dashimages') ?>/my_document.png"></p>
						<p class="expct_name">Lessor Documents</p>
					</div></a>
				</div>
				<div class="col-md-3 text-center padding_t"> 
					<a href="<?php echo Yii::$app->urlManager->createUrl(['/common/documents']) ?>"><div class="expectation_detail">
						<p class="numbr_expct"><img src="<?= Url::to('@web/dashimages') ?>/my_document.png"></p>
						<p class="expct_name">Lessee Documents</p>
					</div></a>
				</div>
