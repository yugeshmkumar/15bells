...
<div class="portlet portlet-sortable sellr_proprty">
        <div class="portlet-title">
                <div class="caption font-green-sharp exp_titl">
                     ...
                     <span class="caption-subject bold uppercase exp_name">Sub Users Expectations</span>
    ...
    <?php echo GridView::widget([
        ...
        'columns' => [
            ...
            'value' => function($data) {
                ...
                return Html::a('<button class="btn btn-default"   id="propertyidprop"  data-html="true"  style="border-color:#0fd8da;border:1px solid;" >View Expectations</button>', $url = '/sellor-expectations/buyer', [
