    ...
    public function behaviors() {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['login', 'error','index','searches','shortlistpropertiesready','Shortlistproperties','viewpropertys', 'shortlistproperties','search','searchaction','mapproperty2update','getpolymyupdate', 'saveprop', 'viewproperty', 'petproperty', 'directitnow', 'getfreevisit', 'bititnow', 'savemessages', 'similiarprop', 'getpolymy', 'mapproperty1','mapproperty1update', 'mapproperty2'],
                        'allow' => true,
                    ],
                    [
