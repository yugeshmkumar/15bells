        ...
        <div class="page-container">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul>
                        <li class="active"><a href="<?php echo Yii::$app->urlManager->createUrl(['/comm/message']) ?>"><i class="fa fa-envelope-open" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Message</span></a></li>
                        <li><a href="<?php echo Yii::$app->urlManager->createUrl(['/comm/message-groups']) ?>"><i class="fa fa-list" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Distribution Groups</span></a></li>
                      <li>
						  <?php echo Html::a(Yii::t('frontend', '<i class="icon-key"></i> Log Out'), ['/user/sign-in/logout'], ['data-method' => 'post']) ?>
</li>
