              ...
              <form class="form-horizontal" method="post" id="footer-form">
                      ...
                      <div class="col-sm-6 post">
                        <div class="caption">
                              ...
                              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14031.815206920684!2d77.071989!3d28.450809!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9e817517fa433ab9!2sENCRISS.com!5e0!3m2!1sen!2sin!4v1485851184170" width="100%" height="500px" frameborder="0" style="border:0" allowfullscreen></iframe>
                              <div class="caption__overlay">
                                  <p class="caption__overlay__content">Address :- 15 Bells f209, first floor, Lado Sarai, New Delhi - 110030.</p>
                                  <h1 class="caption__overlay__title">
                                  <i class="fa fa-phone" aria-hidden="true" style=" position: absolute;top: 67px;left: 140px; color:#2f78b4;font-size: 40px;width: 25px;"></i>+011-40536526,<br>info@gmail.com</h1>
                              </div>
        ...
        <div class="row">
            <div class="col-md-12" style="margin: 40px 0px 40px 0px;">
                   ...
                   <!-- <button type="button" class="btn btn-default"><i class="fa fa-users" aria-hidden="true"></i>&nbsp; &nbsp;READ MORE...</button> -->
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                            ...
                            <li><a href="<?= Yii::$app->urlManager->createUrl("buyer") ?>">BUYERS</a></li>
                            <li><a href="<?= Yii::$app->urlManager->createUrl("seller") ?>">SELLERS</a></li>
                            <li><a href="<?= Yii::$app->urlManager->createUrl("aboutus") ?>" target="_blank">ABOUT US</a></li>
                            <li><a href="<?= Yii::$app->urlManager->createUrl("terms") ?>" target="_blank">TERMS & CONDITIONS</a></li>
                            <li><a href="<?= Yii::$app->urlManager->createUrl("privacy") ?>" target="_blank">PRIVACY POLICY</a></li>                        
                      </ul>
                    </nav>
                ...
                <div class="col-md-4 post4">
                    <h2>CONTACT US</h2><br>
                    <P><i class="fa fa-id-card-o" aria-hidden="true"></i>&nbsp; &nbsp;131 DLF, City Court, Gurgaon</P>
                    ...
                    <h1>
                       ...
                       <li><a href="https://www.facebook.com/15bells/"  class="icoFacebook" title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <li><a href="#" class="icoLinkedin"  target="_blank" title="Linkedin"><i class="fa fa-rss"></i></a></li>
                    </ul>
                    </h1>
