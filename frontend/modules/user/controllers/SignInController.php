                ...
                'rules' => [
                    ...
                    [
                        ...
                        'denyCallback' => function () {
                            return Yii::$app->controller->redirect(['/site/userdash']);
                        }
                    ],
                    [
 ...
 //echo $response;
  ...
  echo $activation;
    ...
    public function actionAjaxsignup(){
        ...
        $modelajax = new SignupForm(['scenario' =>'ajaxsignup']);
        

    if (Yii::$app->request->isAjax && $modelajax->load(Yii::$app->request->post())) 
        {
            ...
            if ($modelajax->load(Yii::$app->request->post())) {


            $designation =  $post['SignupForm']['designation'];

            

                $user = $modelajax->signup();
            ...
            $myprofilestatus->designation = $designation;
            ...
            return ActiveForm::validate($modelajax);
