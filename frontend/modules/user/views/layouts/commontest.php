                ...
                <div class="hor-menu   hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="classic-menu-dropdown">
                            ...
                            <ul class="dropdown-menu pull-left">
                                <li>
                                  <a href="<?php echo Yii::$app->urlManager->createUrl(['lessoraction/index']) ?>">
                                     <i class="fa fa-bookmark-o"></i> Add Property </a>
                                </li>
                                <li>
                                   <a href="<?php echo Yii::$app->urlManager->createUrl(['lessoraction/manage']) ?>">
                                     <i class="fa fa-user"></i> Manage Property</a>
                                </li>

                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['lessoraction/viewp']) ?>">
                                      <i class="fa fa-puzzle-piece"></i> View Property </a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['common/documents']) ?>">
                                      <i class="fa fa-gift"></i>Documents Upload </a>
                                </li>
                                <li>
                            ...
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li>
                                     <a href="<?php echo Yii::$app->urlManager->createUrl(['common/documents']) ?>">
                                        <i class="fa fa-puzzle-piece"></i>Documents Upload </a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['lesseeaction/index']) ?>">
                                        <i class="fa fa-gift"></i> Shortlist Property </a>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed hidden-sm hidden-xs" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
						...
						?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/copostlogin']) ?>" class="nav-link nav-toggle">
                       <?php } else { ?><a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>" class="nav-link nav-toggle"><?php } ?>
							<i class="icon-home"></i>
