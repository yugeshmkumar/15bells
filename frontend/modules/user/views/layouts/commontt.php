                ...
                <div class="hor-menu   hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="classic-menu-dropdown">
                            <a href="javascript:;" data-hover="megamenu-dropdown" data-close-others="true"> BUYER
                      ...
                      <li class="classic-menu-dropdown">
                            <a href="javascript:;" data-hover="megamenu-dropdown" data-close-others="true"> SELLER
                                <i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu pull-left">
							<li>
							...
							<!--
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['selleraction/schedulevisit']) ?>">
                            ...
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li>
                                   <a href="<?php echo Yii::$app->urlManager->createUrl(['landlordaction/manage']) ?>">
                                     <i class="fa fa-user"></i> Manage Property</a>
                                </li>

                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['landlordaction/viewp']) ?>">
                                      <i class="fa fa-puzzle-piece"></i> View Property </a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['common/documents']) ?>">
                                ...
                                <li>
                                   <a href="<?php echo Yii::$app->urlManager->createUrl(['landlordaction/myescrow']) ?>">
                                      <i class="fa fa-table"></i> My Escrow Account </a>
                                </li>
								 <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['landlordaction/addrfp']) ?>">
                            ...
                            <ul class="dropdown-menu pull-left">
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['tenantaction/search']) ?>">
                                        <i class="fa fa-bookmark-o"></i> Search Property</a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['tenantaction/index']) ?>">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
                                    <a href="<?php echo Yii::$app->urlManager->createUrl(['common/documents']) ?>">
                                        <i class="fa fa-file"></i> My KYC Documents </a>
                                </li>
                                <li>
                                    <a href="">
                        ...
                        <li class="dropdown dropdown-quick-sidebar-toggler">
						 <?php echo Html::a(Yii::t('frontend', '<i class="icon-logout"></i>'), ['/user/sign-in/logout'], ['data-method' => 'post','class'=>"dropdown-toggle"]) ?>
                        ...
                        <li class="sidebar-search-wrapper">
                            ...
                            <form class="sidebar-search  sidebar-search-bordered" action="" method="POST">
                                ...
                                <div class="input-group">
                                  <b><font color="#b4bcc8">Hii,<br/><?php echo Yii::$app->user->identity->username ?></font><font color="#36c6d3"><i class="fa fa-circle green"></i></font></b>
                                </div>
                            </form>
                            <!-- END RESPONSIVE QUICK SEARCH FORM -->
                        </li>
                        <li class="nav-item start  active open">
                            <a href="<?php echo Yii::$app->urlManager->createUrl(['site/postlogin']) ?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
						 ...
						 <li class="nav-item">
                            <a href="<?php echo Yii::$app->urlManager->createUrl(['common/shortlist']) ?>" class="nav-link nav-toggle">
