                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="<?= Yii::$app->homeUrl ?>">HOME <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>
                               ...
                               <li><a href="<?= Yii::$app->urlManager->createUrl("/lessee/searchproperty") ?>">SEARCH PROPERTY <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>
                              <li><a href="<?= Yii::$app->urlManager->createUrl("lessor") ?>">LESSOR <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>
                            <!--<li><a href="<?= Yii::$app->urlManager->createUrl("broker") ?>">BROKER <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>-->
                            <li><a href="<?= Yii::$app->urlManager->createUrl("buyer") ?>">BUYER <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>
                            <li><a href="<?= Yii::$app->urlManager->createUrl("seller") ?>">SELLER <b class="middle hidden-xs">&nbsp; &nbsp;|&nbsp; &nbsp;</b></a></li>
