        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'update', 'index', 'create', 'view', 'delete', 'virtual', 'bid', 'insertajax', 'grid', 'endbid', 'changestatus', 'time', 'showamount', 'checkstatus', 'showamount1','seller','maxbidders', 'minraise', 'starttime','ajaxtime','test','test1','chat','dynamic','winnerscreen','notificationtime','getactiveuser','customsound','property'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
  ...
  $model = new Transaction();
   ...
   /*     $amt = "select max(bid_amount) as bid_amount
        ...
        $result_chk = $command_get->queryOne();
		 ...
		 $sql2="select max(reserved_price) as bid_amount from product_details where product_id='$product'";		 
...
return false;
 ...
 $minimumraise=$model->getMinamountraise($product);
...
return false;
 ...
 if ($amt < $max_db_bid) {
	  echo "Add Higher Bid";
        ...
        $stat = $model->getuserstatus($product);
