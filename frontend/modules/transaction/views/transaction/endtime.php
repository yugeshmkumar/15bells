...
// echo '<pre>';print_r($datas[0]['product_id']);die;
...
$brandID =  \common\models\Addproperty::find()->where(['id'=>$product_id])->one();
$branduserid = $brandID->user_id;
if($loggedin == $branduserid){  ?>
